    ...
    ! function(a, b) {
        var famobi = {
                ...
                moreGamesLink: function() {
                    ...
                    var url = "https://www.newb.ml";

                    if(url = this.config.more_games_url) {
                        window.open(url, "https://www.newb.ml") || (window.top.location.href = url);
                    } else {
                        return;

                        confirm("redirecting to... " + url) && (window.open(url, "https://www.newb.ml") || (window.top.location.href = url)); // handles the link target in production version, depends on user language
                    }
